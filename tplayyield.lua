...
blacklistWords = {
    "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE false",
    "/e ABC",
    "le le le le le",
    "AnnaBypasser"
}
...
ChatLog = function(player)
    player.Chatted:Connect(function(message)
        if logsEnabled == true then
            for _,badwords in pairs(blacklistWords) do
                if string.find(message, string.lower(badwords)) or string.find(message, badwords) then
                    return
                end
            end
